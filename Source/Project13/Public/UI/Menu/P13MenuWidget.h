...
UCLASS()
class PROJECT13_API UP13MenuWidget : public UUserWidget
{
	GENERATED_BODY()
...
UCLASS()
class PROJECT13_API UP13LevelSelectWidget : public UUserWidget
{
	GENERATED_BODY()
...
UCLASS()
class PROJECT13_API UP13OptionListWidget : public UUserWidget
{
	GENERATED_BODY()
...
UCLASS()
class PROJECT13_API UP13OptionSliderWidget : public UUserWidget
{
	GENERATED_BODY()
