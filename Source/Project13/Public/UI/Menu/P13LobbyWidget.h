...
#include "Game/P13LobbyGameMode.h"
...
UCLASS()
class PROJECT13_API UP13StartMenuWidget : public UP13MenuWidget
{
	GENERATED_BODY()
...
UCLASS()
class PROJECT13_API UP13SessionSelectWidget : public UUserWidget
{
	GENERATED_BODY()
...
UCLASS()
class PROJECT13_API UP13LobbyLevelSelectWidget : public UP13LevelSelectWidget
{
	GENERATED_BODY()
